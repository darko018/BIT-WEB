...
function getRandom(min, max) {
  ...
  var start = 1;
  var end = 50;
  var randomNum = getRandom(start, end);
  ...
  function roundOfArr(r) {
    return r.map(function (e) {
      return e.toFixed(2);
    })
  }
  
  console.log(roundOfArr(randomNum));
  ...
  console.log(biggestElementOfArray(randomNum));
